...
# 
# **Note**: The value of the import_file string is `"allow_list.txt"` in the activity, but in the exemplar, it is `"data/allow_list.txt"`. This is intentional. A unique copy of `"allow_list.txt"` has been moved to a new folder in the exemplar so that changes made to the file in the activity do not affect the file used in the exemplar.
# 
